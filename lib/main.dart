...
// -------------------- CONSTANTS --------------------
// NOTE: Make sure this is the correct IP for your server deployment
...
class _MainPageState extends State<MainPage> {
  ...
  Future<void> _syncProfileAndGroups({bool forceLoading = true}) async {
    ...
    try {
      final url = Uri.parse("https://$SERVER_IP/profile_and_groups");
      final response = await http.post(
        url,
        headers: {"Content-Type": "application/json"},
          ...
          _isLoading
            ...
            : Expanded(
                child: RefreshIndicator(
                  onRefresh: () => _syncMessages(forceLoading: true),
